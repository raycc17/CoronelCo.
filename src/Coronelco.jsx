...
body {
  ...
  background-position: center, center, 0 0, 13px 19px;
        ...
        .mid-claim {
          ...
          color: #ffffff;
background:
  linear-gradient(120deg, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0.10) 40%, rgba(255,255,255,0.02) 100%),
  linear-gradient(135deg, rgba(95,47,198,0.35) 0%, rgba(15,100,243,0.35) 50%, rgba(95,47,198,0.35) 100%);
